...
import { GitCompare, ThumbsDown, ExternalLink, HelpCircle } from "lucide-react";
          ...
          <div className="flex flex-wrap gap-1.5 items-center">
            ...
            {item.explanations.length > 0 && (
              <button
                ...
                className="text-portal-text-secondary hover:text-portal-blue transition-colors ml-0.5"
              >
                <HelpCircle size={14} />
              </button>
            )}
