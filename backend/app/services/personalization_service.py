...
INDUSTRY_ALLOWED_CATEGORIES: dict[str, list[str]] = {
    "Образование": [
        "Канцелярские товары", "Канцелярия", "Книги", "Учебные пособия",
        "Мебель", "Мебель офисная", "Мебель учебная",
        "IT-оборудование", "Компьютеры", "Оргтехника", "Принтеры",
        "Спортивный инвентарь", "Спорттовары",
        "Хозяйственные товары", "Бытовая химия",
        "Электротехника", "Освещение",
        "Продукты питания", "Питание",
        "Расходные материалы",
    ],
    "Медицина": [
        "Медицинские товары", "Медикаменты", "Лекарственные средства",
        "Расходные материалы", "Расходники",
        "Мебель медицинская", "Мебель", "Мебель офисная",
        "Хозяйственные товары", "Бытовая химия", "Дезинфицирующие средства",
        "IT-оборудование", "Компьютеры", "Оргтехника",
    ...
    "Строительство": [
        ...
        "Электротехника", "Кабели", "Провода",
        "Инструменты", "Электроинструмент", "Ручной инструмент",
        "Крепёж", "Крепежные изделия", "Метизы",
        "Хозяйственные товары",
        "Мебель", "Мебель офисная",
        "Спецодежда", "Средства защиты",
        "Лакокрасочные материалы", "Краски",
        "Сантехника", "Сантехнические изделия",
    ],
    "Стройматериалы": [
        "Стройматериалы", "Строительные материалы",
        "Электротехника", "Кабели", "Провода",
    ...
    "Электротехника": [
        "Электротехника", "Кабели", "Провода", "Освещение",
    ...
    "ЖКХ": [
        "ЖКХ", "Стройматериалы", "Электротехника",
        "Хозяйственные товары", "Бытовая химия",
        "Инструменты", "Сантехника",
        "Спецодежда",
    ],
    "Транспорт": [
        "Транспортные средства", "Запчасти", "Автозапчасти",
        "Электротехника", "ЖКХ", "Инструменты",
    ],
    "Хозяйственные товары": [
        "Хозяйственные товары", "Бытовая химия",
        "Стройматериалы", "ЖКХ", "Инструменты",
    ],
    "Канцелярские товары": [
        "Канцелярские товары", "Канцелярия",
        "Мебель офисная", "IT-оборудование", "Оргтехника",
    ],
}
